...
const SearchFlower3 = ({ navigation }) => {
  const [searchTerm, setSearchTerm] = useState('');

  const flowers = [
    { id: 1, name: 'Sự lãng mạn', price: '149.000đ', image: require('../Appbanhoa/Image/flower13.png') },
    { id: 2, name: 'Sự sang trọng', price: '149.000đ', image: require('../Appbanhoa/Image/flower14.png') },
    { id: 3, name: 'Sự sang trọng', price: '149.000đ', image: require('../Appbanhoa/Image/flower15.png') },
    { id: 4, name: 'Sự sang trọng', price: '149.000đ', image: require('../Appbanhoa/Image/flower16.png') },
    { id: 5, name: 'Sự lãng mạn', price: '149.000đ', image: require('../Appbanhoa/Image/flower17.png') },
    { id: 6, name: 'Sự sang trọng', price: '149.000đ', image: require('../Appbanhoa/Image/flower18.png') },
  ];
    ...
    <View style={styles.container}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.categoryContainer}>
        {['Hàng mới', 'Hoa hồng Đà Lạt', 'Hồng Ngoại Thương', 'Hoa Hồng Cổ'].map((category, index) => (
          ...
          >
            <Text style={index === 2 ? styles.categoryTextActive : styles.categoryText}>{category}</Text>
          </TouchableOpacity>
        ))}
      </ScrollView>
